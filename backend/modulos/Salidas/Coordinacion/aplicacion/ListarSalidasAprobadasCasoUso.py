...
class ListarSalidasAprobadasCasoUso:
    """
    Caso de Uso (Hexagonal puro): Obtiene la lista de salidas que ya pasaron
    el filtro (Favorable / Aprobada) del Coordinador Académico.
    ...
    def ejecutar(self) -> List[SalidaCoordinacionDTO]:
        ...
        # Incluimos todos los estados post-revisión del Coordinador:
        # FAVORABLE: ya validada, esperando Consejo
        # APROBADA: el Consejo la aprobó
        # RECHAZADA: el Consejo la rechazó (pero el Coordinador la evaluó)
        # PENDIENTE_AJUSTE: el Consejo solicitó ajustes adicionales
        estados_aprobados = [
