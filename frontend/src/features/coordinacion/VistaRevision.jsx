  ...
  return (
    <div style={{ background: "#f8fafc", minHeight: "100vh", padding: "30px" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
          <h1 style={{ margin: 0, fontSize: "28px", color: "#0f172a" }}>
            {salida?.nombre || "Geología Estructural"}
          </h1>
          <span
            style={{
              background: "#0f172a",
      ...
      <div style={{ display: "flex", gap: "30px", alignItems: "flex-start" }}>
        ...
        <div
          style={{
            flex: isChecklistExpanded ? "1 1 50%" : "1 1 65%",
            display: "flex",
          ...
          >
            {tabInfo === "general" && (
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: "minmax(400px, 1.8fr) 1fr",
                  gap: "40px",
                }}
              >
                ...
                >
                  <div>
                    ...
                    >
                      {salida?.objetivo_general ||
                        salida?.resumen ||
                        "El docente no especificó un objetivo para esta salida de campo."}
                    </p>
                  </div>
                  ...
                  <div style={{ padding: "0" }}>
                    ...
                    >
                      {salida?.justificacion ||
                        "El profesor no ha proporcionado una justificación detallada para esta salida de campo."}
                    </p>
                  </div>
                  ...
                  {salida?.estrategia_metodologica && (
                    <div style={{ padding: "0" }}>
                      ...
                      >
                        ESTRATEGIA METODOLÓGICA Y PRODUCTOS ESPERADOS
                      </h4>
                      <p
                        style={{
                          margin: "0 0 10px 0",
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {salida?.profesor_nombre ||
                          `Docente (ID: ${salida?.profesor_id || "N/A"})`}
                      </span>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      {salida?.asignatura || "Sin Asignatura"}{" "}
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ fontSize: "14px", color: "#334155" }}>
                        {salida?.num_estudiantes || 0} Cupos Estimados
                      </span>
                    </div>
                    <div
                      style={{
                  ...
                  >
                    ...
                    >
                      {salida?.fecha_inicio || "Sin definir"}{" "}
                      <span style={{ color: "#cbd5e1", margin: "0 8px" }}>
                        —
                      </span>{" "}
                      {salida?.fecha_fin || "Sin definir"}
                    </span>
                  </div>
                </div>
              </div>
            ...
            {tabInfo === "itinerario" && (
              ...
              >
                <div>
                  ...
                  >
                    Itinerario Proyecto por el Profesor
                  </h3>
                  <p style={{ margin: 0, color: "#64748b", fontSize: "13px" }}>
                    Puedes navegar el itinerario y hacer clic en las paradas
                    para visualizar su programación detallada. La edición está
                    bloqueada en esta vista.
                  </p>
                </div>

                {isLoadingDetail ? (
                  <p style={{ color: "#64748b", fontSize: "15px" }}>
                    Cargando itinerario enrutado desde la base de datos...
                  </p>
                ) : (
                  <div
                    style={{
                  ...
                  >
                        ...
                        <div style={{ marginBottom: "15px" }}>
                          ...
                          >
                            ...
                            >
                              {pRuta.length > 0
                                ? pRuta[0].nombre
                                : salida?.punto_partida || "Sin definir"}
                            </span>
                          </div>
                        </div>
                        <div>
                          ...
                          >
                            ...
                            >
                              {pRuta.length > 0
                                ? pRuta[pRuta.length - 1].nombre
                                : salida?.parada_max || "Sin definir"}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            ...
                            >
                              {pRetorno.length > 0
                                ? pRetorno[pRetorno.length - 1].nombre
                                : salida?.punto_partida || "Sin definir"}
                            </span>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            {salida?.distancia_total_km || 0} km
                          </div>
                        </div>
                      </div>
                      <div
                    ...
                    >
                      <KanbanItinerario
                        ...
                        onEditarParadaRetorno={(idx) =>
                          handleVerParada(idx, true)
                        }
                        isReadOnly={true}
                      />
                    </div>
            ...
            {tabInfo === "presupuesto" && (
              ...
              >
                <div>
                  ...
                  >
                    Desglose Presupuestal Solicitado
                  </h3>
                  <p style={{ margin: 0, color: "#64748b", fontSize: "13px" }}>
                    Evaluación de los costos logísticos integrales requeridos
                ...
                >
                  ...
                  >
                    ...
                    >
                      ${(salida?.costo_estimado || 0).toLocaleString("es-CO")}{" "}
                      COP
                    </div>
                    <p
                      style={{ fontSize: "13px", color: "#64748b", margin: 0 }}
                    >
                      Cálculo estimado basado en el itinerario completo.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <span style={{ fontWeight: "bold" }}>Nota:</span> Para esta
                  versión académica, el centro de costos proyectado se resume en
                  el componente global y los gastos de movilidad basados en los{" "}
                  {salida?.duracion_dias || 1} días proyectados.
                </div>
              </div>
            )}
            {tabInfo !== "general" &&
              ...
              tabInfo !== "presupuesto" && (
                <p style={{ color: "#64748b" }}>
                  Contenido de {tabInfo} (Simulado para demostración)
                </p>
              )}
          </div>
        </div>
        ...
        <div
          style={{
            flex: isChecklistExpanded ? "1 1 50%" : "1 1 35%",
            background: "#fff",
            borderRadius: "12px",
            border: "1px solid #e2e8f0",
            overflow: "hidden",
        ...
        >
          ...
          >
            <div>
              ...
              >
                {PanelDerecho
                  ? "Aprobación y autorización económica de la salida de campo."
                  : "Aprobación y evaluación final de las condiciones logísticas y pedagógicas de esta ruta."}
              </p>
            </div>
            <button
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Configuración establecida por el profesor
                </span>
              </div>
            </div>
                ...
                <div>
                  ...
                  >
                    <span style={{ fontWeight: "500" }}>
                      {paradaVer.tiempo_estimado ||
                        paradaVer.tiempoEstimado ||
                        "--"}
                    </span>
                    <span
                      style={{
                ...
                >
                  ...
                  >
                    <svg viewBox="0 0 20 20" fill="currentColor">
                      <path
                        fillRule="evenodd"
                        d="M9.69 18.933l.003.001C9.89 19.02 10 19 10 19s.11.02.308-.066l.002-.001.006-.003.018-.008a5.741 5.741 0 00.281-.145c.182-.1.422-.25.69-.44a13.684 13.684 0 001.986-1.725C14.866 14.89 16.5 12.29 16.5 9a6.5 6.5 0 10-13 0c0 3.29 1.634 5.89 3.209 7.612a13.684 13.684 0 001.986 1.725 8.007 8.007 0 00.69.44c.12.066.216.11.281.145l.018.008.006.003zM10 11.25a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    <span style={{ fontWeight: "500" }}>
                      {paradaVer.fechaProgramada ||
                        paradaVer.fecha_programada ||
                        "dd/mm/aaaa"}
                    </span>
                    <div
                      style={{
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      {(
                        paradaVer.horaProgramada ||
                        paradaVer.hora_programada ||
                        "--:--"
                      ).split(":")[0] || "--"}
                    </div>
                    <strong style={{ color: "#94a3b8", fontSize: "1.3rem" }}>
                      :
                    </strong>
                    <div
                      style={{
              ...
              {paradaVer.notasItinerario && (
                <div style={{ marginTop: "20px" }}>
                  ...
                  >
                    NOTAS / RECORDATORIOS (ITINERARIO)
                  </span>
                  <div
                    style={{
                      background: "#f8fafc",
